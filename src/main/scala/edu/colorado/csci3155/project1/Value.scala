...
object ValueOps {
    ...
    def plus(v1: Value, v2: Value): Value = op_values(v1, v2, (a, b) => NumValue(a + b))
    def minus(v1: Value, v2: Value)  = op_values(v1, v2, (a,b) => NumValue(a - b))
    def mult(v1: Value, v2: Value)  = op_values(v1, v2, (a,b) => NumValue(a * b))
    def div(v1: Value, v2: Value)  = op_values(v1, v2, (a,b) => NumValue(a / b))
    def geq(v1: Value, v2: Value)  = op_values(v1, v2, (a,b) => BoolValue(a >= b))
    def gt(v1: Value, v2: Value)  = op_values(v1, v2, (a,b) => BoolValue(a > b))
